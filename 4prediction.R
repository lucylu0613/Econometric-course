...
# Let us calculate confidence intervals of the forecast for all the observations in the sample and draw the upper and lower limits together with the regression line
...
# The quadratic model yields  R2g=0.188, and the log-linear model yields  R2g=0.186; 
